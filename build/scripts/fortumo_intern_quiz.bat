...
@rem ##########################################################################
@rem
@rem  fortumo_intern_quiz startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and FORTUMO_INTERN_QUIZ_OPTS to pass JVM options to this script.
...
:fail
rem Set variable FORTUMO_INTERN_QUIZ_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%FORTUMO_INTERN_QUIZ_EXIT_CONSOLE%" exit 1
exit /b 1
